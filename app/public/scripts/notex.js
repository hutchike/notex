...
var notex = {
  ...
  markup: function(text) {
    ...
    text = text.replace(/\b@(\w+)\b/g, '<a href="http://twitter.com/$1" target="_blank">@$1</a>');
    text = text.replace(/\b#(\w+)\b/g, '<a href="http://twitter.com/#search?q=%23$1" target="_blank">#$1</a>');
    return text;
  },
  load: function() {
